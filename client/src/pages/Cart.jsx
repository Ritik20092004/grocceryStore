...
const Cart = () => {
    const {products , currency ,cartItems, user ,removeFromCart, setCartItems , getCartAmount , updateCartItem , navigate ,getCartCount , axios} = useAppContext();
    ...
    const getCart = ()=>{
      ...
      for(const key in cartItems){
        ...
        if (product) {
            product.quantity = cartItems[product._id]; // add quantity for easy access
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {addresses.map((address , index)=>(<p onClick={() =>{ setShowAddress(false);
